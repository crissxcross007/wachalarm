...
const regionColors = {
  ...
  "Barnim": "#d1d5db",
  "Oberhavel": "#d1d5db",
  "Ostprignitz-Ruppin": "#d1d5db",
  "Potsdam-Mittelmark": "#d1d5db",
  "Prignitz": "#d1d5db",
  "Teltow-Fläming": "#d1d5db",
  "Uckermark": "#d1d5db"
};
...
function regionStyle(name, hover) {
  ...
  return {
    ...
    opacity: status === "planned" ? 0.72 : 0.86,
    fillColor: color,
    fillOpacity: status === "active" ? (active ? 0.56 : (hover ? 0.48 : 0.34)) : (hover ? 0.28 : 0.18),
