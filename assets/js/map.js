...
Der Fehler ist exakt hier in deiner Datei:

Du hast aktuell:

fetchJson(localWachalarmUrls).catch(() => [])

Das ist falsch, weil localWachalarmUrls ein Array ist.

Ersetze in deiner Datei komplett diese Funktion:
...
lädt nordwest.json
Prignitz-Pin erscheint
Popup öffnet automatisch
spätere weitere JSON-Dateien funktionieren ebenfalls automatisch
...
if (target) target.innerHTML = "Die Kartenbibliothek konnte nicht geladen werden. Bitte Internetverbindung prüfen.";
...
if (!items.length) {
list.innerHTML = "Keine passenden Kanäle gefunden. Bitte Suche oder Filter anpassen.";
return;
}
...
legend.innerHTML = <span class="legend-dot-v4 dot-main"></span>roter Pin = Hauptkanal Landkreis / Stadt<br> <span class="legend-dot-v4 dot-kommune"></span>orangener Pin = Amt / Gemeinde / Stadt<br> <span class="legend-dot-v4 dot-ortswehr-evi"></span>blauer Pin = Ortswehr mit EVI<br> <span class="legend-dot-v4 dot-ortswehr-ohne-evi"></span>grauer Pin = Ortswehr ohne EVI;
}
}
